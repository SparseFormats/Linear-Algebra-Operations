...
//---- DENSE:
int a_dense[ ROWS ][ COLS ], c_dense[ ROWS ][ COLS ];
...
void matrix_transpose_rows_cols(int a_val[], int a_col[], int a_row[], int a_rowPtr[], int a_val_col_row[ NZrowMax + 1 ][ 3 ], int a_val_row[ ROWS ][ NZrowMax ], int a_index_row[ ROWS ][ NZrowMax + 1], val_col_node * a_row_list[], int a_row_max, int a_col_max, int c_val[], int c_col[], int c_row[], int c_rowPtr[], int c_val_col_row[ NZrowMax + 1 ][ 3 ], int c_val_row[ ROWS ][ NZrowMax ], int c_index_row[ ROWS ][ NZrowMax + 1], val_col_node * c_row_list[], int *c_row_max, int *c_col_max){
  int i;
  ...
  int vec_size_1_pr;
    ...
    for (i = 0; i < a_row_max; i++){
      ...
      case COO_PROTECTED_0:
        Pick_a_row_COO_protected_0( a_val_col_row, i, vec_val_1, vec_index_1, &vec_size_1);
        break;
	//  case COO_PROTECTED_1:       Pick_a_row_COO_protected_1( a_val_col_row, p_i, vec_val_1, vec_index_1, &vec_size_1); 
	break;
      case ELLPACK_PROTECTED_1:
	Pick_a_row_ELLPACK_protected_1( a_val_row, a_index_row, a_col_max, i, vec_val_1, vec_index_1, &vec_size_1);
	break;
...
void matrix_transpose_cols_rows(int a_val[], int a_col[], int a_row[], int a_rowPtr[], int a_val_col_row[ NZrowMax + 1 ][ 3 ], int a_val_row[ ROWS ][ NZrowMax ], int a_index_row[ ROWS ][ NZrowMax + 1], val_col_node * a_row_list[], int a_row_max, int a_col_max, int c_val[], int c_col[], int c_row[], int c_rowPtr[], int c_val_col_row[ NZrowMax + 1 ][ 3 ], int c_val_row[ ROWS ][ NZrowMax ], int c_index_row[ ROWS ][ NZrowMax + 1], val_col_node * c_row_list[], int *c_row_max, int *c_col_max){
  int j;
  ...
  for (j = 0; j < a_col_max; j++){
    ...
    //---- Pick col j of a
      ...
      case DENSE_PROTECTED_0:
        Pick_a_col_DENSE_protected_0( a_dense, a_row_max, j, vec_1);
        break;
      case CRS_PROTECTED_0:
        Pick_a_col_CRS_protected_0( a_val, a_col, a_rowPtr, a_row_max , j, vec_val_1, vec_index_1, &vec_size_1);
        break;
      case CRS_PROTECTED_1:
        //Pick_a_col_CRS_protected_1( a_val, a_col, a_rowPtr, a_row_max, j,  a_col_max, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case SLL_PROTECTED_0:
	Pick_a_col_SLL_protected_0( a_val, a_col, a_row, a_row_max, j, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case SLL_PROTECTED_1:
	//Pick_a_col_SLL_protected_1( a_val, a_col, a_row, j, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case COO_PROTECTED_0:
	Pick_a_col_COO_protected_0( a_val_col_row, a_row_max, j, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case COO_PROTECTED_1:
	//Pick_a_row_COO_protected_1( a_val_col_row, j, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case ELLPACK_PROTECTED_0:
	Pick_a_col_ELLPACK_protected_0( a_val_row, a_index_row, a_row_max, a_col_max, j, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case ELLPACK_PROTECTED_1:
	//      Pick_a_col_ELLPACK_protected_1( a_val_row, a_index_row, a_col_max, j, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case LIL_PROTECTED_0:
	Pick_a_col_LIL_protected_0( a_row_list, a_row_max, a_col_max, j, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case LIL_PROTECTED_1:
	//Pick_a_col_LIL_protected_0( a_row_list, j, vec_val_1, vec_index_1, &vec_size_1);
	break;
      }
      vec_size_1_pr = max( 0, min( vec_size_1, COLS ));
	...
	*/  
      ...
      *c_col_max = a_row_max;
      switch (SPARSE){
      case DENSE_PROTECTED_0:
	Append_a_row_DENSE_protected_0(c_dense, vec_1, c_row_max);
	break;
      case CRS_PROTECTED_0:
	Append_a_row_CRS_protected_0(c_val, c_col, c_rowPtr, vec_val_1, vec_index_1, vec_size_1_pr, c_row_max);
	break;
	...
	break;
      case COO_PROTECTED_0:
	Append_a_row_COO_protected_0( c_val_col_row, vec_val_1, vec_index_1, vec_size_1_pr, c_row_max); 
	break;
      case COO_PROTECTED_1:      // Pick_a_row_COO_protected_1( a_val_col_row, i, vec_val_1, vec_index_1, &vec_size_1);
	break;
      case ELLPACK_PROTECTED_0:
	Append_a_row_ELLPACK_protected_0( c_val_row, c_index_row, vec_val_1, vec_index_1, vec_size_1_pr, (*c_col_max), c_row_max);
	/*int k;
          for (k = 0; k < (*c_row_max); k++){
            printf("row:%d\n",k);
            printVecI(c_val_row[k], (*c_col_max));
...
//====================== MAIN ===========================//
void main(){
  /*  FILE *alaki = fopen("./alaki.txt","w");
  long long int myalaki = 0;// 123456789123456789;
  long long int myalaki2 = 100;
  fprintf(alaki, "adad ine: %lld\n", myalaki);
  fclose(alaki);   
  */
  ...
  c_row[0] = ROWS;
  //--- COO
  a_val_col_row[0][2] = ROWS;
  b_val_col_row[0][2] = ROWS;
...
start_spr_addr[ Nspr + 1 ] = (int *) &(a_row_list[ 0 ]);
  ...
  */
  ...
  //int per_order[COLS];
  //processLineVec(per_order, COLS, per_file);
  ...
  //matrix_transpose_rows_cols(a_val, a_col, a_row, a_rowPtr, a_val_col_row, a_val_row, a_index_row, a_row_list, a_rowMax, a_colMax, c_val, c_col, c_row, c_rowPtr, c_val_col_row, c_val_row, c_index_row, c_row_list, &c_rowMax, &c_colMax);
matrix_transpose_cols_rows(a_val, a_col, a_row, a_rowPtr, a_val_col_row, a_val_row, a_index_row, a_row_list, a_rowMax, a_colMax, c_val, c_col, c_row, c_rowPtr, c_val_col_row, c_val_row, c_index_row, c_row_list, &c_rowMax, &c_colMax);
