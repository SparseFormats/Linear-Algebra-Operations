...
#outfile = open('rand_multiply_100.txt', 'w')
outfile = open('rand_multiply_10.txt', 'w')
np.savetxt(outfile , [width_a], fmt = '%d')
np.savetxt(outfile , [length_b], fmt = '%d')
