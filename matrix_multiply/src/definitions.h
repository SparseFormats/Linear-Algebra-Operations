...
#define INPUT_FILE_1 "../data/rand1_maxINT_100.txt"
#define INPUT_FILE_2 "../data/rand2_maxINT_100.txt"
#define INPUT_FILE_MUL "../data/rand_multiply_100.txt"

/*
#define INPUT_FILE_1 "../data/rand10.txt"
#define INPUT_FILE_2 "../data/rand10.txt"
#define INPUT_FILE_MUL "../data/rand_multiply_10.txt"
*/
/*
