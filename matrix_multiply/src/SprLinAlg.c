...
//---- DENSE:
int a_dense[ ROWS ][ COLS ], b_dense[ ROWS ][ COLS ];
...
void matrix_multiplication(int a_val[], int a_col[], int a_row[], int a_rowPtr[], int a_val_col_row[ NZrowMax + 1 ][ 3 ], int a_val_row[ ROWS ][ NZrowMax ], int a_index_row[ ROWS ][ NZrowMax + 1], val_col_node * a_row_list[], int a_row_max, int a_col_max, int b_val[], int b_col[], int b_row[], int b_rowPtr[], int b_val_col_row[ NZrowMax + 1 ][ 3 ], int b_val_row[ ROWS ][ NZrowMax ], int b_index_row[ ROWS ][ NZrowMax + 1], val_col_node * b_row_list[], int b_row_max, int b_col_max, int **c){
  ...
  int i, j, p_i, p_i_pr,  k = a_col_max;
  ...
  int vec_row[ a_col_max ], vec_col[ b_row_max ], vec_res[ a_col_max];
  ...
  for (i = 0; i < a_row_max; i++){
    ...
    case ELLPACK_PROTECTED_0:   
      ...
      break;
    case LIL_PROTECTED_0:       Pick_a_row_LIL_protected_0( a_row_list, i, vec_val_1, vec_index_1, &vec_size_1); 
      break;
    case LIL_PROTECTED_1:       Pick_a_row_LIL_protected_0( a_row_list, i, vec_val_1, vec_index_1, &vec_size_1); 
      break;
    ...
    for (j = 0; j < b_col_max; j++){
      ...
      switch (SPARSE){
      case DENSE_PROTECTED_0:
	Pick_a_col_DENSE_protected_0( b_dense, b_row_max, j, vec_col); 
	break;
      case CRS_PROTECTED_0:    
	Pick_a_col_CRS_protected_0( b_val, b_col, b_rowPtr, b_row_max, j, vec_val_2, vec_index_2, &vec_size_2); 
	break;
      case CRS_PROTECTED_1: 
	Pick_a_col_CRS_protected_1( b_val, b_col, b_rowPtr, b_row_max, j, b_col_max, vec_val_2, vec_index_2, &vec_size_2); 
	break;
      case SLL_PROTECTED_0:       
	Pick_a_col_SLL_protected_0( b_val, b_col, b_row, b_row_max, j, vec_val_2, vec_index_2, &vec_size_2); 
	break;
      case SLL_PROTECTED_1:       
	...
	break;
      case ELLPACK_PROTECTED_0:   
	Pick_a_col_ELLPACK_protected_0( b_val_row, b_index_row, b_row_max, b_col_max, j, vec_val_2, vec_index_2, &vec_size_2); 
	break;
      case ELLPACK_PROTECTED_1:   
	Pick_a_col_ELLPACK_protected_1( b_val_row, b_index_row, b_row_max, b_col_max, j, vec_val_2, vec_index_2, &vec_size_2); 
	break;
	...
	Pick_a_col_LIL_protected_1( b_row_list, b_row_max, b_col_max, j, vec_val_2, vec_index_2, &vec_size_2); 
	break;
      case JAD_PROTECTED_0:       
	Pick_a_col_JAD_protected_0( b_JADptr, b_val, b_col, b_row_order, b_row_max, j, b_col_max, vec_val_2, vec_index_2, &vec_size_2);
	//printf("jad_col %d\n", j); 
	break;
      }
	...
	*/  
      ...
      switch(SPARSE){
      case DENSE_PROTECTED_0:
	spr_vectors_op_DENSE(vec_row, vec_col, vec_res, a_col_max, '.');
...
start_spr_addr[ Nspr + 1 ] = (int *) &(a_row_list[ 0 ]);
  ...
  case JAD_PROTECTED_1:
    ...
    //    printf("a_row_order\n");
    //printVecI(a_row_order, a_rowMax);
    //printVecI(a_val, 4);
    /*
